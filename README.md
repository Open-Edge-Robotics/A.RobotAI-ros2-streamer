...
### 2. Ros Streamer Viewer Run with Arguments

```bash
# Viewer with arguments
python ros_stream_viewer/viewer.py stream --host 136.166.201.33 --port 15555
# Short version
python ros_stream_viewer/viewer.py stream -h 136.166.201.33 -p 15555
```

### 3. Ros Streamer Viewer Run with Predict

```bash
# Viewer with predict
python ros_stream_viewer/viewer.py predict --host 136.166.201.33 --port 15555
# Short version
python ros_stream_viewer/viewer.py predict -h 136.166.201.33 -p 15555
```
